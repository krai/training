...
export EXTRA_PARAMS='--target-map=0.37 --lr 0.0001 --output-dir=/results --dataset=coco --resume=/model/openimage_train_coco_finetune_model_12_acc35.pth --warmup-epochs=2'
